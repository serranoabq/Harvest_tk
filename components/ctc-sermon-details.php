...
<?php if( $speaker_str ) {	?>
			...
			<div class="ctc-sermon-speaker li"><i class="fa fa-<?php echo $users; ?>" aria-hidden="true"></i><?php echo $speaker_str; ?></div>

<?php } if( $series_str ) {	?>

			<div class="ctc-sermon-series li"><i class="fa fa-th-list" aria-hidden="true"></i><a href="<?php echo esc_url( $series_link ); ?>"><?php echo $series_str; ?></a></div>
