...
?>
	...
	<?php if( $date_str ) {	?>
			...
			<div class="ctc-event-date li"><i class="fa fa-calendar" aria-hidden="true"></i><?php echo $date_str; ?></div>

	<?php } if( $time_str ) {	?>

			<div class="ctc-event-time li"><i class="fa fa-clock-o" aria-hidden="true"></i><?php echo $time_str; ?></div>

	<?php } if( $recurrence_note ) {	?>

			<div class="ctc-event-recurrence li"><i class="fa fa-repeat" aria-hidden="true"></i><?php echo $recurrence_note; ?></div>
		
	<?php } if( $categories ) {	?>

			<div class="ctc-event-categories li"><i class="fa fa-tag" aria-hidden="true"></i><?php echo $categories; ?></div>
	

	<?php } if( $venue_str ) { ?>	

			<div class="ctc-event-venue li"><i class="fa fa-building" aria-hidden="true"></i><?php echo $venue_str; ?></div>
	
	<?php } if( $address_str ) { ?>

			<div class="ctc-event-address li"><i class="fa fa-map-marker" aria-hidden="true"></i><?php echo nl2br( $address_str ); ?></div>
